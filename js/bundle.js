...
function modal(triggerSelector, modalSelector, modalTimerId) {
    ...
    modalTrigger.forEach((btn) => { 
        btn.addEventListener('click', () => openModal(modalSelector, modalTimerId)); // функция внутри стрелочной функции, потому что вторым аргументом мы должны передавать функцию без скобок
                                                                       // в нашем же случае, мы должны передать аргумент
                                                                       // чтобы обойти это, нужно функцию обернуть в стрелочную функцию 
    });         
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    total.textContent = (0,_script__WEBPACK_IMPORTED_MODULE_0__.getZero)(slides.length);
    current.textContent = (0,_script__WEBPACK_IMPORTED_MODULE_0__.getZero)(slideIndex);
...
function timer(id, deadline) {
    ...
    function setClock(selector, endtime){
        ...
        function updateClock(){
            ...
            days.innerHTML = (0,_script__WEBPACK_IMPORTED_MODULE_0__.getZero)(t.days);
            hours.innerHTML = (0,_script__WEBPACK_IMPORTED_MODULE_0__.getZero)(t.hours);
            minutes.innerHTML = (0,_script__WEBPACK_IMPORTED_MODULE_0__.getZero)(t.minutes);
            seconds.innerHTML = (0,_script__WEBPACK_IMPORTED_MODULE_0__.getZero)(t.seconds);
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__.default)('.timer', '2021-09-22');
...
/* harmony export */ });
// функция, которая настраивает запрос, посылает запрос на сервер, получает ответ и трансформирует ответ в объект
// такие функции называют сервисами и обычно выносят их в отдельную папку и файлы
